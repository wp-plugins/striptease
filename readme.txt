...
This jump can be disorienting, and some bloggers prefer to link their teasers to the full post instead of the unread text.
...
= 1.1 =
* Removed an unnecessary call to get_permalink()
